...
class DonutsControllerTest < ActionController::TestCase
  ...
  test "should create donut" do
    assert_difference('Donut.count') do
      post :create, donut: { cost: @donut.cost, extras: @donut.extras, image: @donut.image, name: @donut.name }
    end
  ...
  test "should update donut" do
    patch :update, id: @donut, donut: { cost: @donut.cost, extras: @donut.extras, image: @donut.image, name: @donut.name }
    assert_redirected_to donut_path(assigns(:donut))
  end
